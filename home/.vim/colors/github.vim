...
" {{{ PHP
hi phpInclude   guifg=#000000 gui=bold
hi phpType   guifg=#000000 gui=bold
hi phpIdentifier guifg=#008080
hi phpVarSelector guifg=#008080
hi phpFCKeyword guifg=#000000 gui=bold
hi phpStatement guifg=#900900 gui=bold
hi phpParent guifg=#000000
hi phpFoldFunction guifg=#900900 gui=bold
" }}}
